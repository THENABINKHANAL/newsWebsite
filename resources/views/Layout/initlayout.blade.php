...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Charm|ZCOOL+QingKe+HuangYou" rel="stylesheet"> 
    <link href="https://fonts.googleapis.com/css?family=Open+Sans" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Coda|Corben" rel="stylesheet">
        ...
        <nav class="header">
                <div class="header-box" style="z-index:200;">
                    <a class="logo-link" href="{{url('/')}}">
                        <img class="logo" id="mainlogo" src="{{ asset('assets/img/SVG/lict_logo.svg') }}"/>
                    </a>
                    ...
                    <div class="nav-bar-box box-mobile">
                        ...
                        <div class="ham-container">
                                <div class="mobsearch">
                                        ...
                                        <input class="mobsearchBox" placeholder="Search..">
...
<div id="id00" class="modal" style="z-index:400;">
  ...
  <!--   End    -->
  <div style="min-height: calc(100vh - 20vw);">
            @yield('content')
        </div>
            <footer id="footer">
